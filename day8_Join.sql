...
/*============================== JOIN İSLEMLERİ ===============================
    ...
    3) RIGHT JOIN: Sadece Ikinci tabloda(sag) olan tum sonuclari gosterir
...
select sirket_isim, siparis_id, siparis_tarih,sirket_id
from siparisler
...
select b.bolum_isim, p.perseonel_isim, p.maas
